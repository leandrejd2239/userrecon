...
# modifier par @leandrejd2239
# https://github.com/leandrejd2239/
...
printf "                               modifier: @leandrejd2239          \e[1;92m'.__.' \e[0m\n"
...
check_face=$(curl -s "https://pornhub.com/$username" -L -H "Accept-Language: en" | grep -o 'not found'; echo $?)


if [[ $check_face == *'1'* ]]; then
printf "\e[1;92m Found!\e[0m https://www.pornhub.com/%s\n" $username
printf "https://pornhub.com/%s\n" $username >> $username.txt
